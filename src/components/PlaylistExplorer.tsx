        ...
        >
            ...
            <div className="flex-1 min-h-0 flex items-center justify-center w-full max-w-md relative z-10 py-2">
                ...
                >
                    ...
                    {/* Tonearm overlay: scale/position from record-tonearm-reference.svg (record r=225, pivot 477.69,94.09; tonearm 373×407) */}
                    <div
                        className="absolute inset-0 pointer-events-none overflow-visible"
                        aria-hidden
                        style={{
                            // record-tonearm-reference: record diameter 450, tonearm 373×407 → width 373/450, height 407/450 of container
                            // Pivot (477.69,94.09) vs record center (225,259) → pivot at 1.0615×R right, 0.1335×L from top
                            // Tonearm.svg pivot at (240.69/373, 94.09/407) → place SVG so that point hits (106.15%, 13.35%)
                            left: "52.66%",
                            top: "-7.56%",
                            width: "82.89%",
                            height: "90.44%",
                    ...
                    >
                        ...
                        >
                            <defs>
                                {/* Shadow for pivot circle to reduce flatness */}
                            ...
                            {/* Pivot circle: dynamic (current genre/theme); shadow adds depth */}
                            <circle cx="240.694" cy="94.0881" r="47.5" transform="rotate(-17.9996 240.694 94.0881)" fill={vinylColors.accentColor} filter="url(#tonearm-pivot-shadow)" />
                            <path d="M240.046 57.5257C241.216 52.6324 245.84 49.3706 250.843 49.9094L251.944 50.028C257.937 50.6735 262.001 56.4351 260.598 62.2974L219.327 234.787C218.971 236.276 218.278 237.663 217.301 238.842L146.466 324.295C142.175 329.471 134.091 328.985 130.45 323.332C128.133 319.735 128.378 315.058 131.058 311.722L198.28 228.021C199.206 226.868 199.865 225.523 200.209 224.085L240.046 57.5257Z" fill="#D9D9D9" />
                            {/* Cartridge / needle tip: realistic vinyl theme (fixed) */}
                            <path d="M121.183 369.034C119.533 371.486 116.128 371.98 113.85 370.098L95.4512 354.9C93.2506 353.083 93.0156 349.795 94.9352 347.682L134.97 303.631C136.77 301.65 139.812 301.438 141.869 303.151L153.549 312.876C155.52 314.517 155.93 317.382 154.499 319.51L121.183 369.034Z" fill={REALISTIC_VINYL_THEME.accentColor} />
                            <circle cx="162.096" cy="351.18" r="4.47665" transform="rotate(-56.8972 162.096 351.18)" fill={REALISTIC_VINYL_THEME.accentColor} />
                            <rect width="8.9533" height="25.5809" transform="translate(137.686 340.61) rotate(-56.8972)" fill={REALISTIC_VINYL_THEME.accentColor} />
                            <path d="M246.27 12.6119C246.891 9.92121 249.575 8.24333 252.266 8.86426L271.754 13.3614C274.445 13.9824 276.122 16.667 275.502 19.3577L259.332 89.4238C258.855 91.4914 257.125 93.0326 255.016 93.2685L233.947 95.625C230.521 96.0082 227.744 92.8908 228.519 89.5317L246.27 12.6119Z" fill={REALISTIC_VINYL_THEME.accentColor} />
                        </svg>
                    </div>
